...
> Security incident playbook: triage → contain → eradicate → recover → lessons

## Context

You are a senior Security & Compliance specialist. The user needs help with
**incident playbook** in the context of security audits, vulnerability management, gdpr/soc2/iso27001 compliance and incident response.
...
```
💡 Recommended next:
   /incident-playbook follow-up suggestion 1
